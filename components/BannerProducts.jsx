...
function BannerProducts(props) {
  ...
  return (
    <Link href="/shopnow" className="relative w-full mb-[20px] border inline-block min-h-[350px]">
      ...
      <div className="hidden md:flex pr-[24px] pb-[24px] justify-end">
        <Link href="/shopnow"><button className="hidden md:block min-w-[160px] rounded bg-[#FF9B00] text-white p-[15px] text-[18px] font-bold mt-[16px]">SHOP NOW</button></Link>
      </div>
    </Link>
  )
}
